...
public class Menu {
  ...
  class MainMenu extends Entity {
    ...
    String phrase = "";
    String[] phrases = new String[] {"Now in technicolor.", "Dispatching victory since 2015.",
        "Available in TRANSACT MODE.", "Did you check in LogicTransferToSettlement?",
        "Here comes the BOOM.", "A handful of people in a leaky reefer to save the world.",};
    ...
    final private void handleUserControl() {
      ...
      if (selector == 2) {
        if (i2 >= 0 && (i2 < tanks2.size()))
          menu.t2 = tanks2.get(i2);
      }
      if (selector == 3) {
        if (i3 >= 0 && (i3 < tanks3.size()))
          menu.t3 = tanks3.get(i3);
      }
      if (selector == 4) {
        if (i4 >= 0 && (i4 < tanks4.size()))
          menu.t4 = tanks4.get(i4);
      }
    }
    ...
    public void draw(Graphics2D g) {
      ...
      // PLAYER 1
      if (menu.t1 != null) {
        g.drawImage(menu.t1.getIcon(), new AffineTransform(2.0f, 0f, 0f, 2.0f, 101, characterY),
            null);
      ...
      // PLAYER 2
      if (menu.t2 != null) {
        g.drawImage(menu.t2.getIcon(), new AffineTransform(2.0f, 0f, 0f, 2.0f, 214, characterY),
            null);
      ...
      // PLAYER 3
      if (menu.t3 != null) {
        g.drawImage(menu.t3.getIcon(), new AffineTransform(2.0f, 0f, 0f, 2.0f, 327, characterY),
            null);
      ...
      // PLAYER 4
      if (menu.t4 != null) {
        g.drawImage(menu.t4.getIcon(), new AffineTransform(2.0f, 0f, 0f, 2.0f, 441, characterY),
            null);
